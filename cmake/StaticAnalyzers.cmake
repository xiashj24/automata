...
macro(myproject_enable_clang_tidy target WARNINGS_AS_ERRORS)
  ...
  # Add common Homebrew paths only on macOS.
  if(APPLE)
...
macro(myproject_enable_cpplint)
  ...
  if(CPPLINT)
    ...
    message(${WARNING_MESSAGE} "cpplint requested but executable not found")
  endif()
endmacro()
...
macro(myproject_enable_link_what_you_use)
